        ...
        <div className="col-md-6 col-md-offset-3  formbox">
          ...
          <form onSubmit={this.login}>
            <div className="form-group">
              ...
              <input onChange={this.handleUsernameChange} type="text" className="form-control input-font input" id="username" placeholder="Enter Your Username" />
            </div>
            <div className="form-group">
              <label className="label" htmlFor="loginPassword">PASSWORD</label>
              <input onChange={this.handlePasswordChange} type="password" className="form-control input-font input" id="loginPassword" placeholder="Enter Your Password"/>
            </div>
        ...
        <div>
          <div className=" well formbox account-form">
            ...
            <form onSubmit={this.signUp}>
              <div className="form-group">
                <label className="label" htmlFor="username">USERNAME</label>
                <input onChange={this.handleUsernameChange} type="text" className="form-control input-font input" id="username" placeholder="Enter A New Username" />
              </div>
              <div className="form-group">
                <label className="label" htmlFor="loginPassword">PASSWORD</label>
                <input onChange={this.handlePasswordChange} type="password" className="form-control input-font input" id="loginPassword" placeholder="Enter A New Password"/>
              </div>
              <div className="login-button">
